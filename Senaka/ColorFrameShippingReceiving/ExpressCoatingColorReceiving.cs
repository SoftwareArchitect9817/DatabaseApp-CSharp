...
namespace Senaka
{
    public partial class ExpressCoatingColorReceiving : Form
    {
        ...
        public ExpressCoatingColorReceiving()
        {
            InitializeComponent();
        ...
        private void scanInput(string data)
        {
            ...
            foreach (string[] r in Settings.ExpressCoating_Color_Receiving_Prefix_Table)
            {
            ...
            if (exist_prefix)
            {
                ...
                if (frame_cutting_data != null)
                {
                    ...
                    List<string[]> dvcoatex_shipping = DB.fetchRows("ExpressCoatingColorReceiving", "line", id);
                    ...
                    if (scanned_qty < 1)
                    {
                        if (frame_cutting_data[16] != "WHT" || frame_cutting_data[17] != "WHT")
                        {
                            ...
                            if (DB.saveExpressCoatingColorReceivingData(id, date, time, name, batch_number) == 0)
                            {
                                bool exists = false;
